...
<head>
  ...
  <title>singUp</title>
  <link rel="stylesheet" href="/miniproject/resources/css/signup.css">
  ...
  <div id="container">
    ...
    <main>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>아이디 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="text" name="member-id"></td>
          </tr>
          <tr>
            <td>비밀번호 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="password" name="member-pw"></td>
          </tr>
          <tr>
            <td>비밀번호 확인 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="password" name="member-pw2"></td>
          </tr>
          <tr>
            <td>이름 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="text" name="member-name"></td>
          </tr>
          <tr>
            <td>이메일 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="email" name="member-email"></td>
          </tr>
          <tr>
            <td>전화번호 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="text" name="member-phone"></td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
            <td class="tfoot-td" colspan="2">
              <h4 style="margin-bottom: 20px;">[필수] 이용약관 동의</h4>
              <textarea name="" id="" cols="81" rows="8">제1조(목적)
이 약관은 상은당 회사(전자상거래 사업자)가 운영하는 상은당 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 상은당 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다. 부 칙(시행일) 이 약관은 2021년 03월 24일부터 시행합니다.</textarea>
              <span> 이용약관에 동의하십니까? </span> <input type="checkbox" name="TOS" id="" value=""> <span>동의함 </span>
            </td>
          </tr>

          <tr>
            <td class="tfoot-td" colspan="2">
              <h4 style="margin-bottom: 20px;">[필수] 개인정보 수집 및 이용 동의</h4>
              <textarea name="" id="" cols="81" rows="8"> 
