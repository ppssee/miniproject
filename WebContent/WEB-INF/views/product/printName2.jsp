      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td><input type="text" id="product-name" name="product-name" value="${product.productName }" readonly></td>
          </tr>
          <tr>
            <td>상품 가격 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="text" id="product-price" name="product-price" value="${product.productPrice }" readonly></td>
          </tr>
          <tr>
            <td>상품 수량 <img src="/miniproject/resources/img/singUpImg/ico_required.gif" width="10px"></td>
            <td><input type="text" id="product-count" name="product-count" value="${product.productCount }" readonly></td>
          </tr>
